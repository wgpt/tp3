...
return array(
    ...
    'MODULE_DENY_LIST' => array('Common', 'Runtime', 'Model', 'Server', 'MDP'), // 禁止访问模块
    'MODULE_ALLOW_LIST' => array('Web'), // 允许访问模块
    'CONTROLLER_LEVEL' => 1,
    ...
    'DB_RW_SEPARATE' => true,       // 数据库读写是否分离 主从式有效，默认第一台服务器为写入服务器，其它的只读取不写入
    ...
    'HTML_READ_TYPE' => 0, //读取缓存方式
    'HTML_CACHE_RULES' => array(  // 定义静态缓存规则
        '*' => array('{$_SERVER.REQUEST_URI|md5}'),  //根据当前的URL进行缓存(定义全局的静态缓存规则，这个属于特殊情况下的使用，任何模块的操作都适用)
    ),
